const TABS = [
  {
    ...
    icon: (active) => (
      <svg width="24" height="24" viewBox="0 0 24 24" fill={active ? "var(--clay)" : "none"} stroke={active ? "var(--clay)" : "var(--gray-500)"} strokeWidth="1.8" strokeLinecap="round" strokeLinejoin="round">
  ...
  },
  {
    ...
    icon: (active) => (
      <svg width="24" height="24" viewBox="0 0 24 24" fill="none" stroke={active ? "var(--clay)" : "var(--gray-500)"} strokeWidth="1.8" strokeLinecap="round">
